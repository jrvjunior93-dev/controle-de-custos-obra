...
export const OrdersModule: React.FC<OrdersModuleProps> = ({ project, sectors, mentionableUsers, user, onUpdate, onPersistOrder, onUpdateOrderSectorStatus, onAddOrderMessage, onDeleteOrder, onRefreshProjects }) => {
